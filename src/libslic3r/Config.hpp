...
// When parsing a configuration value, if the old_value is not understood by this Verslicer version,
// it is being substituted with some default value that this Verslicer could work with.
