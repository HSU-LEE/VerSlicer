...
typedef int (*func_search_makerworld)(void *agent, const char *query, int limit, const char *locale,
                                      const char *printer_model, std::string *json_body,
                                      unsigned int *http_code, std::string *http_error);
typedef int (*func_get_makerworld_download_url)(void *agent, const char *design_id, std::string *download_url,
...
public:
    ...
    func_search_makerworld get_search_makerworld() const { return m_search_makerworld; }
    func_get_makerworld_download_url get_get_makerworld_download_url() const { return m_get_makerworld_download_url; }
...
private:
    ...
    func_search_makerworld m_search_makerworld{nullptr};
    func_get_makerworld_download_url m_get_makerworld_download_url{nullptr};
