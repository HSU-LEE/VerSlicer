    ...
    Button(parent, text)
{
    ...
    StateColor btn_bd_green(std::pair<wxColour, int>(wxColour(255, 255, 254), StateColor::Disabled),
        std::pair<wxColour, int>(wxColour(255, 143, 74), StateColor::Enabled));
    ...
    const wxColour panel_bg = StateColor::darkModeColorFor(wxColour(59, 68, 70));
    StateColor btn_bg_panel(
        std::make_pair(wxColour(206, 206, 206), (int) StateColor::Disabled),
        std::make_pair(panel_bg, (int) StateColor::Pressed),
        std::make_pair(panel_bg, (int) StateColor::Hovered),
        std::make_pair(panel_bg, (int) StateColor::Normal));
    StateColor btn_bd_panel(
        std::make_pair(wxColour(255, 255, 254), (int) StateColor::Disabled),
        std::make_pair(StateColor::darkModeColorFor(wxColour("#EEEEEE")), (int) StateColor::Enabled));
    StateColor btn_text_panel(
        std::make_pair(wxColour(255, 255, 254), (int) StateColor::Disabled),
        std::make_pair(StateColor::darkModeColorFor(wxColour("#363636")), (int) StateColor::Enabled));
    ...
    case CaliPageActionType::CALI_ACTION_MANUAL_CALI:
    case CaliPageActionType::CALI_ACTION_AUTO_CALI:
        SetBackgroundColor(btn_bg_panel);
        SetBorderColor(btn_bd_panel);
        SetTextColor(btn_text_panel);
        break;
    case CaliPageActionType::CALI_ACTION_PREV:
    case CaliPageActionType::CALI_ACTION_RECALI:
...
{
    m_parent = parent;
    SetBackgroundColour(StateColor::darkModeColorFor(wxColour(59, 68, 70)));
