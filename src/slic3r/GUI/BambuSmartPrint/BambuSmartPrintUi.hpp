...
/** Ensures the closed combo shows the selected choice label (fixes empty display in dark UI). */
...
/** Native wxChoice row — reliable label display on macOS dark UI (Smart Print assistant). */
