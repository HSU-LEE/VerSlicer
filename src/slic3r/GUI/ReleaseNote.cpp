    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Release Note"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    auto sm = create_scaled_bitmap("Verslicer", nullptr,  70);
    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Network plug-in update"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    auto sm = create_scaled_bitmap("Verslicer", nullptr, 55);
    ...
    operation_tips = new ::Label(this, Label::Body_12, _L("Click OK to update the Network plug-in when Verslicer launches next time."), LB_AUTO_WRAP);
...
UpdateVersionDialog::UpdateVersionDialog(wxWindow *parent)
    : DPIDialog(parent, wxID_ANY, _L("New version of Verslicer"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
    SetBackgroundColour(*wxWHITE);
    ...
    auto sm    = create_scaled_bitmap("Verslicer", nullptr, 64);
...
void UpdateVersionDialog::update_version_info(wxString release_note, wxString version)
{
    ...
    auto style    = "body {color:" + fg_color + "; background-color:" + bg_color + "; font-family:sans-serif}"
                  + "a    {color: #FF8F4A}"               // matches hyperlink colors
...
void ConfirmBeforeSendDialog::edit_cancel_button_txt(const wxString& txt, bool switch_green)
{
    ...
    if (switch_green)
    {
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 130, 70), StateColor::Pressed),
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    comfirm_before_enter_text = _L("1. Please confirm Verslicer and your printer are in the same LAN.");
    ...
    m_test_right_msg->SetForegroundColour(wxColour(255, 159, 122));
