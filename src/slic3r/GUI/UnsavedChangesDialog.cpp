...
static wxColour unsaved_dialog_surface() { return StateColor::darkModeColorFor(GREY200); }
static wxColour unsaved_dialog_category_bar() { return StateColor::darkModeColorFor(GREY300); }
static wxColour unsaved_dialog_text() { return StateColor::darkModeColorFor(GREY900); }
static wxColour unsaved_dialog_muted_text() { return StateColor::darkModeColorFor(GREY700); }
...
void UnsavedChangesDialog::build(Preset::Type type, PresetCollection *dependent_presets, const std::string &new_selected_preset, const wxString &header)
{
    ...
    m_action_line->SetForegroundColour(unsaved_dialog_text());
    ...
    m_panel_tab->SetBackgroundColour(unsaved_dialog_surface());
    ...
    m_table_top->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    m_panel_temp->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    static_temp_title->SetForegroundColour(unsaved_dialog_text());
    ...
    title_block_middle->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    m_panel_oldv->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    static_oldv_title->SetForegroundColour(unsaved_dialog_text());
    ...
    title_block_right->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    m_panel_newv->SetBackgroundColour(unsaved_dialog_category_bar());
    ...
    static_newv_title->SetForegroundColour(unsaved_dialog_text());
    ...
    m_scrolledWindow->SetBackgroundColour(unsaved_dialog_surface());
   ...
   /* m_info_line = new wxStaticText(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(-1, 44), 0);
    ...
    if (dependent_presets != nullptr) {
        auto wiki = new HyperLink(this, _L("Help"), "https:///wiki/transfer_discard_changes");
...
void UnsavedChangesDialog::update_list()
{
    ...
    for (auto iter = class_c_list.begin(); iter != class_c_list.end(); iter++) {
        ...
        panel_category->SetBackgroundColour(unsaved_dialog_category_bar());
        ...
        text_category->SetForegroundColour(unsaved_dialog_text());
        ...
        for (auto i = 0; i < iter->second.size(); i++) {
            ...
            for (auto g = 0; g < class_g_list[gname].size(); g++) {
                ...
                if (g == 0) {
                     ...
                     panel_item->SetBackgroundColour(unsaved_dialog_surface());
                     ...
                     panel_left->SetBackgroundColour(unsaved_dialog_surface());
                     ...
                     text_left->Wrap(-1);
                     text_left->SetForegroundColour(unsaved_dialog_muted_text());
                ...
                panel_oldv->SetBackgroundColour(unsaved_dialog_surface());
                ...
                text_oldv->Wrap(-1);
                text_oldv->SetForegroundColour(unsaved_dialog_muted_text());
                ...
                panel_newv->SetBackgroundColour(unsaved_dialog_surface());
                ...
                text_newv->Wrap(-1);
                text_newv->SetForegroundColour(unsaved_dialog_muted_text());
