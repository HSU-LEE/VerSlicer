...
public:
    ...
    bool        open_menubar_item(const wxString& menu_name,const wxString& item_name);
#ifdef _WIN32
    ...
    void        select_tab(TabPosition pos);
    int         page_index_for(TabPosition pos) const;
    bool        is_tab_selected(TabPosition pos) const;
    ...
    wxPanel*              m_smart_print_page{ nullptr };
    BambuSmartPrintPanel* m_smart_print_panel{ nullptr };
