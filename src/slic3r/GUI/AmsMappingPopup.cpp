...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#FF8F4A")));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 130, 70), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 143, 74), StateColor::Normal));
