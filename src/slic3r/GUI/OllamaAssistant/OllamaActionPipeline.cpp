...
bool OllamaActionPipeline::high_confidence_rule_only_intent(const std::string& /*user_request*/)
{
    return false;
}

nlohmann::json OllamaActionPipeline::build_rule_only_apply_root(const std::string& /*user_request*/,
                                                              bool /*include_makerworld*/)
{
    nlohmann::json root = nlohmann::json::object();
    root["actions"]     = nlohmann::json::array();
