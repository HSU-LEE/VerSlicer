...
void ImGuiWrapper::push_confirm_button_style() {
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#E67A2E")));
        ImGui::PushStyleColor(ImGuiCol_Border, ImVec4(0.f / 255.f, 143.f / 255.f, 74.f / 255.f, 1.f));
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#FF9F5A")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#E67A2E")));
        ...
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#FF8F4A")));
        ImGui::PushStyleColor(ImGuiCol_Border, ImVec4(0.f / 255.f, 143.f / 255.f, 74.f / 255.f, 1.f));
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#FFB07A")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#FF8F4A")));
...
void ImGuiWrapper::push_combo_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG_DARK);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.f, 143.f / 255.f, 74.f / 255.f, 0.6f));  // ORCA hovered item border color
        ...
        ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(0.f, 143.f / 255.f, 74.f / 255.f, 0.25f));       // ORCA active item background color
...
void ImGuiWrapper::push_radio_style(const float scale)
{
    ...
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#FF8F4A"))); // ORCA use orca color for radio buttons
