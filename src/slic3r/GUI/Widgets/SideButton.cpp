    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(255, 130, 70), StateColor::Pressed);
    border_color.append(wxColour(255, 159, 122), StateColor::Hovered);
    border_color.append(0xFF8F4A, StateColor::Normal);
    ...
    background_color.append(wxColour(255, 130, 70), StateColor::Pressed);
    background_color.append(wxColour(255, 159, 122), StateColor::Hovered);
    background_color.append(0xFF8F4A, StateColor::Normal);
