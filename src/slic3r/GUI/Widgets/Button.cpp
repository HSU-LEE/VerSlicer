    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xFFB07A, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0xFF8F4A, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#FF8F4A", "#FF8F4A"};
wxString btn_confirm[10]  = {"#DFDFDF", "#FF8F4A", "#FFB07A", "#FF8F4A", "#FF8F4A", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#FFB07A", "#FFC89A"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#FF8F4A", "#FF8F4A"};
