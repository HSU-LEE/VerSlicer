...
static std::map<wxColour, wxColour> gDarkColors{
    {"#FF8F4A", "#E67A2E"}, // Verslicer brand orange
    ...
    {"#FFB07A", "#E67A2E"}, // rgb(255, 143, 74)    Button Confirm Color hover | ORCA Color Hover
    ...
    {"#EDFAF2", "#3A3028"}, // rgb(229, 240, 238)  Not Used anymore // Was used for BBS Combo / Dropdown focused background color
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#FFE0CC", "#3D2A1F"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#FFF0E5", "#3A3028"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
