...
/*#ifdef __WXOSX__
    ...
    StateColor box_border_colour(std::pair<wxColour, int>(wxColour("#FF8F4A"), StateColor::Normal)); // ORCA match border color with other input/combo boxes
...
void TabPrinter::toggle_options()
{
    ...
    if (m_active_page->title() == L("Multimaterial")) {
        ...
        // Verslicer: hide specific settings for BBL printer
        for (auto el : {
