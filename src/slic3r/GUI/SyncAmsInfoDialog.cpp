    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    // icon
    std::string icon_path = (boost::format("%1%/images/VerslicerTitle.ico") % resources_dir()).str();
   ...
   // m_sizer_main->Add(m_basic_panel, 0, wxEXPAND | wxLEFT | wxRIGHT, FromDIP(15));
    ...
    {//new content//tip confirm ok button
        ...
        m_more_setting_tips->SetForegroundColour(wxColour(255, 130, 70));
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 130, 70), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 159, 122), StateColor::Hovered),
